...
export const EVOLUTION_GOLDEN_LOCKS = Object.freeze({
  ...
  headerDigest: '6b872cadac00b3a56463bcc8e0f55b14bc290c3c0b2e04568f4fc1d9bfcce51b',
    ...
    // +34 bytes per member). The header digest is UNCHANGED (the history
    // format itself did not move); population, metadata and lineage digests
    // are unchanged bit-exact — only the fitness-vector bytes moved, so each
    // payload grew by exactly 6 × 34 bytes and the chained digests follow.
    // v2 history digest was 'da573ca5f22247cba5712a96c6738f48b360330c4b54d3ba5b16a4ed1ef20e55'.
