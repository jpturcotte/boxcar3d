...
export const EVOLUTION_GOLDEN_LOCKS = Object.freeze({
  'evolution-a-small-flat': Object.freeze({
    ...
    // fitness-vector encoding v3 persists the five integrity observations per
    // member; NO policy, selection or mutation behaviour change). The header
    // binds NO vector version, so headerByteLength and headerDigest MUST NOT
    // move; the population/metadata/lineage components are byte-identical;
    // only each generation's fitnessVectorDigest, generationDigest,
    // payloadByteLength and the historyDigest/historyByteLength move
    // (+34 B/member ⇒ +204 B/record at population 6).
    headerByteLength: 536,
  headerDigest: '6b872cadac00b3a56463bcc8e0f55b14bc290c3c0b2e04568f4fc1d9bfcce51b',
    historyByteLength: 12738,
  historyDigest: '8cab787fd085b3ac64f18c762ba75c9d12b8037e7d71b32abd4efcd05f0d01ff',
    generations: Object.freeze([
      Object.freeze({
        generationIndex: 0,
        terminalReason: 'none',
        payloadByteLength: 5028,
        ...
        fitnessVectorDigest: '7e1581469127935657a194d33b4b203913b32c0065eb1fc70796e59ef6d5bb19',
        lineageDigest: 'c52861e2e49e01ee126e21aed5457a7861dc88bf2828fd1a43d6fd8958fb0df5',
      generationDigest: '86d3bbc2153b39b988ee54414308a59183584a6d0969975c517a562c1b4331e0',
      ...
      Object.freeze({
        generationIndex: 1,
        terminalReason: 'none',
        payloadByteLength: 3620,
        populationByteLength: 2816,
        populationDigest: '8c0d31a262b8fe0c8d637bf6e3e08e547fef5f494dd5e406504d946fa070913d',
        evaluationMetadataDigest: '141f4f5dd18c1cefc2279f9e37c1cc72283c6268da79f99d6864cb69600215b6',
        fitnessVectorDigest: '9ddd398c4c0fe60f19e5b76c2a233ab255aa249d28ec568250f486c42503ef13',
        lineageDigest: '9cef6fec4c6b1e05032f39c66d54ac4c1d269587c46405e3e8909f6945cbd1b2',
      generationDigest: 'f9182e6947b0334ea5116abb59107a80a26bc5e18b26285c1792b73de754deed',
        lineage: Object.freeze([
      ...
      Object.freeze({
        ...
        payloadByteLength: 3364,
        populationByteLength: 2560,
        populationDigest: 'ad488da2fb9eeb6e3568e6efd7a26c15b9708bf74c319c707f8fa7fda821a8d4',
        evaluationMetadataDigest: '141f4f5dd18c1cefc2279f9e37c1cc72283c6268da79f99d6864cb69600215b6',
        fitnessVectorDigest: 'a7119d6d88cfa9875274dc7f97c80c3ac0b96ca10781cd4cd1015c45bbb0addd',
        lineageDigest: '9da05866c4bdfa487ff2958b008bf4d62ca4800b9bdd93fb5913b370758178ff',
      generationDigest: 'c78872b66b1b1ec06d5749dee88f9b0b9de31db55beacafea59773e604becbf4',
        lineage: Object.freeze([
