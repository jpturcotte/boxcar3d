...
async function resumeFromOwnedBytes(owned, expected) {
  ...
  // Stage 8a: fitness-vector compatibility — a stale wire version is refused
  // as unsupportedVersion here, before any physics.
  checkFitnessVectorCompatibility(verified);
  // Stage 8b: fitness-vector ↔ metadata coherence — a semantic contradiction
  // is refused as malformedHistory here, before any physics.
